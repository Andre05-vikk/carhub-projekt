# Generated by Django 3.0.7 on 2025-02-15 08:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('TT', 'Tartu'), ('TA', 'Tallinn')], max_length=255)),
                ...
                ('features', multiselectfield.db.fields.MultiSelectField(choices=[('Cruse Control', 'Cruise Control'), ('Audio Interface', 'Audio Interface'), ('Airbags', 'Airbags')], max_length=37)),
                ('body_style', models.CharField(max_length=100)),
                ('engine', models.CharField(max_length=100)),
                ('transmission', models.CharField(max_length=100)),
                ('interior', models.CharField(max_length=100)),
                ('miles', models.IntegerField()),
                ('doors', models.CharField(choices=[('2', '2'), ('3', '3')], max_length=10)),
